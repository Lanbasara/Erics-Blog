...
exports.runUnmounted = exports.runMounted = exports.runBoostrap = exports.runBeforeLoad = exports.setLifeCycle = void 0;
...
var runBeforeLoad = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                app.status = enums_1.AppStatus.LOADED;
...
var runBoostrap = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (app.status !== enums_1.AppStatus.LOADED) {
                    return [2 /*return*/, app];
                }
                app.status = enums_1.AppStatus.BOOTSTRAPPING;
                return [4 /*yield*/, ((_a = app.boostrap) === null || _a === void 0 ? void 0 : _a.call(app, app))];
            case 1:
                _b.sent();
                app.status = enums_1.AppStatus.NOT_MOUNTED;
                return [2 /*return*/];
        }
    });
}); };
...
var runMounted = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                app.status = enums_1.AppStatus.MOUNTING;
                return [4 /*yield*/, ((_a = app.mount) === null || _a === void 0 ? void 0 : _a.call(app, app))];
            case 1:
                _b.sent();
                app.status = enums_1.AppStatus.MOUNTED;
...
var runUnmounted = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                app.status = enums_1.AppStatus.UNMOUNTING;
                app.proxy.inactive();
